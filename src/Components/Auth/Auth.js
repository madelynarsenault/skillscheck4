...
import { getSession, registerUser, loginUser } from "../../redux/UserReducer";
    ...
    return (
      <div className="loginBackground">
            <div className="loginDiv">
                ...
                <button onClick={() => this.handleLogin(username, password)} className="loginButton">Login</button>
                    <button onClick={() => this.handleRegister(username, password)}className="registerButton">register</button>
                </div>
            </div>
            </div>
